<template>
  <div class="block1Container" :style="{ height: height + 'px' }">
    <div class="blockContent">
      <div class="infoBox">
        <div class="blockTitle">AI Editor</div>
        <Split></Split>
        <div class="infoList">
          <p class="infoRow">是一个智能编辑器</p>
          <p class="infoRow">同时也是一个全能ai助手</p>
          <p class="infoRow">开源、免费、强大...</p>
        </div>
        <div class="desc">无论你是开发者，还是使用者，只要喜欢大模型，都能在这个项目里找到你需要的。</div>
        <div class="btnBox">
